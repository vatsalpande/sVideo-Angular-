function ShowData($http) {
  ...
  function getShowById(id) {
    var completeShowCollection = allShows();
    var showById = {};
    completeShowCollection.shows.forEach((item)=> {
        if (item.imdbID === id) {
          showById = item;
        }
    });
